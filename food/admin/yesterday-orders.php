...
<?php include_once 'sidenev.php'; ?> 
 ...
 $sql = "SELECT o.id, o.totalprice, o.orderstatus, o.paymentmode, o.`timestamp`, u.firstname, u.lastname FROM orders o JOIN usersmeta u WHERE o.uid=u.uid AND DATE(timestamp) = '$yes'";
