			...
			if(isset($name) && !empty($name)){
				if(($extension == "jpg" || $extension == "jpeg") && $type == "image/jpeg" && $size<=$max_size){
					...
					if(move_uploaded_file($tmp_name, $location.$name)){
						...
						echo $sql = "INSERT INTO pets (petname, petdescription, petcategory, gender,age, trained, adopt, thumb) VALUES ('$prodname', '$description', '$category', '$gender', '$age', '$trained', '10', '$location$name')"; 
						$res = mysqli_query($connection, $sql);
						if($res){
							//echo "Product Created";
							header('location: ../complete-massage.php');
						}else{
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<div class="billing-details">
						<h3 class="uppercase">pet owner info</h3>
				    ...
				    <label for="Productname"><strong> Pet Name</strong></label>
				    <input type="text" class="form-control" name="petname" id="Productname" placeholder="Pet Name" required="">
				  </div>
				  <div class="form-group">
				    <label for="productdescription"> <strong>Describe where and how  you pet lost</strong></label>
