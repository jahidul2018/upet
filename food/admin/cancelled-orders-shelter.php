	...
	<div class="content-blog">
		<div class="container">
			<table class="table table-striped">
				...
				<tbody>
		 		 <?php 	
					$sql = "SELECT o.id, o.totalprice, o.orderstatus, o.paymentmode, o.`timestamp`, u.firstname, u.lastname FROM orders o JOIN usersmeta u WHERE o.uid=u.uid AND ivid LIKE 'Shel%' AND orderstatus='Cancelled'  ORDER BY o.id DESC";
