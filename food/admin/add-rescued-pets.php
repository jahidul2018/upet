<?php
	...
	if(isset($_POST) & !empty($_POST)){
        ...
        $rescued_date = filter_var($_POST['rescued_date'], FILTER_SANITIZE_NUMBER_INT);
        $res = mysqli_real_escape_string($connection, $_POST['res']);
			...
			if(isset($name) && !empty($name)){
				if(($extension == "jpg" || $extension == "jpeg") && $type == "image/jpeg" && $size<=$max_size){
					...
					if(move_uploaded_file($tmp_name, $location.$name)){
						...
						echo $sql = "INSERT INTO pets (petname, petdescription, petcategory, gender,age, trained, adopt, thumb, rescued_date, rescued_by) VALUES ('$prodname', '$description', '$category', '$gender', '$age', '$trained', 3, '$location$name', '$rescued_date', '$res')";
						$res = mysqli_query($connection, $sql);
						if($res){
							//echo "Product Created";
							header('location: pet-rescued-list.php');
						}else{
			...
			$sql = "INSERT INTO pets (petname, petdescription, petcategory, gender,age, trained, adopt, rescued_by) VALUES ('$prodname', '$description', '$category', '$gender', '$age', '$trained', 3, '$res')";
			$res = mysqli_query($connection, $sql);
			if($res){
				header('location: pet-rescued-list.php');
			}else{
	...
	<div class="content-blog">
		...
		<?php if(isset($smsg)){ ?><div class="alert alert-success" role="alert"> <?php echo $smsg; ?> </div><?php } ?>
			...
			<form method="post" enctype="multipart/form-data">
				  ...
				  <div class="form-group">
                    ...
                    <br>
                     ...
                     <div class="form-group">
                    <label for="Productname">Rescue Date</label>
                    
                    <input type="date" class="form-control" id="billing_phone" name="rescued_date" required="" >  
			...
			<br/>
                ...
                <!-- /.row onclick="return confirm('Are you sure you want to Submit?');" -->
