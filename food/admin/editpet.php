...
if(isset($_POST) & !empty($_POST)){
		...
		$sql = "UPDATE pets SET petname='$prodname', petdescription='$description', petcategory='$category', gender='$gender', age='$age', trained='$trained', thumb='$filepath' , rescued_by='$res' WHERE id = $id";
