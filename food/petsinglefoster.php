			...
			<?php if(isset($smsg)){ ?><div class="alert alert-success" role="alert"> <?php echo $smsg; ?> </div><?php } ?>
					<div class="row">
						...
						<div class="col-md-7 product-single">
							...
							<!--add pet details-->
								...
								<p><strong><em>Found date : </em><?php echo $prodr['rescued_date']; ?></strong></p>
								<p><strong><em>Rescued By : </em><?php echo $prodr['rescued_by']; ?></strong></p>
							<!--End pet details-->
							<br>
							...
							<div class="shop-btn-wrap">
								<input type="submit" class="button btn-small" value="Return To Home"> <br>
					...
					<div class="related-products">
						...
						<div class="row">
							...
							<?php
								$relsql = "SELECT * FROM pets WHERE id != $id and adopt ='3' ORDER BY rand() LIMIT 3";
