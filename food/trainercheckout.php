...
if(isset($_POST) & !empty($_POST)){
	if($_POST['agree'] == true){
		...
		$tri = filter_var($_POST['shelterdate'], FILTER_SANITIZE_NUMBER_INT);
		...
		if($count == 1){
			...
			if($ures){
				...
				if($iores){
					...
					$orditmsql = "INSERT INTO orderitems (pid, orderid, productprice, pquantity, tri) VALUES ('$pid', '$orderid', '$productprice', '$quantity','$tri')";
		                 ...
		                 //$mail->SMTPDebug = 2;                             
		                  ...
		                  if(!$mail->send()) {
		                    ...
		                    //$fmsg = "Invalid Login Credentials";
		                          ...
		                          unset($_SESSION['cart']);
		                        header("location: complete-massage-trainer.php");
		                  }
					...
					<div class="billing-details">
						...
						<div class="space30"></div>
							...
							<div class="row">
							    ...
							    <label for="productdescription"> Why do you want a trainer </label>
							    <textarea class="form-control" name="why" rows="3" required=""></textarea>
							  	</div>
							  	<div class="">
								<span>confirm Start Date:</span> 
								<?php $date = date("Y-m-d", strtotime("+ 7 days"));?>
								<input type="date" class="form-control" id="billing_phone" name="shelterdate" min="<?php echo $date;?>" max="2019-12-01" required="" >
...
<div class="payment-method">
	...
	<div class="col-md-4">
		<input name="payment" id="radio1" class="css-checkbox" type="radio" disabled="" value="cash on delivery"> <span>Cash</span>
		<div class="space20"></div>
		<p>"Cash On Delivery"||Make your payment directly into our delivery man. Please use your Order ID as the payment reference.</p>
	</div>
