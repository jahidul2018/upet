...
<div class="container">
  ...
  <div  class="error">
   <!--  <p class="p">4</p>
    ...
    <div class="page-ms">
      <p class="page-msg">Your Account has been created <span><p></p></span></p>
	   <p class="page-msg">please check your Email for Activitation Link <span><p></p></span></p>
	    <p class="page-msg"> <span>Thank You<p></p></span></p>
      <a href="login-myaccount-volunteer.php"><button class="go-back" >Log in</button></a>
    </div>
</div>
