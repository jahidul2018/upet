   ...
   <!--  <p class="p">4</p>
    <span class="dracula">      
      <div class="con">
        ...
        <div class="mouth"></div>
        <div class="blod"></div>Your request will be cancled
    ...
    <div class="page-ms">
      <p class="page-msg">Congratulations. Your adoption application is Complate<span><p></p></span></p>
		<p class="page-msg">Our volunteer will contact with you for deliver your adopted Pet<span><p></p></span></p>
	    <p class="page-msg"> <span>Thank You<p></p></span></p>
      <a href="petapplication.php"><button class="go-back" >Confirm Application</button></a> 
    </div>
</div>
