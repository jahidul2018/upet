			...
			if($ures){
				...
				if($iores){
					...
					//query for data that send to email .
				      $information="SELECT name, totalprice From products, orders, orderitems where orders.id=orderitems.orderid and orderitems.pid=products.id and orders.ivid='$ivid'";
		                 ...
		                 //$mail->SMTPDebug = 2;                             
		                  ...
		                  if(!$mail->send()) {
		                    ...
		                    //$fmsg = "Invalid Login Credentials";
		                        ...
		                        header("location: complete-massage-purchasefod.php");
		                  }
...
<div class="payment-method">
	...
	<div class="col-md-4">
		<input name="payment" id="radio1" class="css-checkbox" type="radio" value="cash on delivery" disabled=""> <span>Cash On Delivery</span>
