...
<div class="container">
  ...
  <div  class="error">
   <!--  <p class="p">4</p>
    ...
    <div class="page-ms">
      <p class="page-msg">Congratulations. Your order is placed<span><p></p></span></p>
		<p class="page-msg">Confirm your Payment for your product and delivery<span><p></p></span></p> 
	    <p class="page-msg"> <span>Thank You<p></p></span></p>
      <a href="my-account.php"><button class="go-back" > Confirm Order</button></a>
    </div>
</div>
