					...
					<div class="col-md-12">
                       ...
                       $pdo = Database::connect();
                          include("pagination/function.php");
                            ...
                            $statement = 'products ORDER BY id DESC'; //you have to pass your query over here//chanre the table1 name
							...
							?>
								<div class="sm-item isotope-item">
									<div class="product">
										...
										<div class="product-price">$ <?php echo $row['price']; ?>.00/-<span></span></div>
									</div>
								</div>
							<?php }
