...
<div class="container">
  ...
  <div  class="error">
   <!--  <p class="p">4</p>
    ...
    <div class="page-ms">
      <p class="page-msg"> we received Your Request <span><p></p></span></p>
	   <p class="page-msg">we will try our level best to find your pet<span><p></p></span></p>
	    <p class="page-msg"> <span>Thank You<p></p></span></p>
      <a href="../index.html"><button class="go-back" >OK</button></a>
    </div>
</div>
