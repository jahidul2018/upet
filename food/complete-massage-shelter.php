...
<div class="container">
  ...
  <div  class="error">
   <!--  <p class="p">4</p>
    ...
    <div class="page-ms">
      <p class="page-msg">Congratulations. Your Booking Requerst is Complate<span><p></p></span></p>
	  <p class="page-msg"> Confirm your Payment or Your request will be cancled <span><p></p></span></p>
		<p class="page-msg">After payment confirmation we will contact with you for pick up Your pet as requier date<span><p></p></span></p>
	    <p class="page-msg"> <span>Thank You<p></p></span></p>
      <a href="shelterapplication.php"><button class="go-back" >Confirm Booking</button></a>
    </div>
</div>
