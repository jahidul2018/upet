...
<?php include 'inc/trainernav.php'; ?>
									...
									<div class="product">
										<div class="product-thumb">
											...
											<div class="product-overlay">
												<span>
												<a href="trainersingle.php?id=<?php echo $r['id']; ?>" class="fa fa-link"></a>
										...
										<h2 class="product-title"><a href="petsingle.php?id=<?php echo $r['id']; ?>"><?php echo $r['tname']; ?></a></h2>
