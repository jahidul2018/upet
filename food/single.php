...
/*$idsql = "SELECT COUNT(`pquantity`) as 'number of time', products.stock FROM orderitems, products WHERE orderitems.pid=products.'$id' GROUP by orderitems.pid";
		$res = mysqli_query($connection, $idsql); 
		while ($r = mysqli_fetch_assoc($res)) {
				$x= $r['stock']-$r['number of time'];
					echo $x;
					exit();
				};*/
						...
						<div class="col-md-7 product-single">
							...
							<div class="product-quantity">
								<span>Quantity:</span> 
									...
									<input type="number" name="quant" placeholder="" min="1" max="" value="<?php echo $value['quantity']; ?>">
