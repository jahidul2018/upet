			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<div class="billing-details">
						<h3 class="uppercase">Cancel Order</h3> <br>
				...
				<?php } ?>
						...
						<div class="space30"></div>
							...
							<label>Reason :</label>
							<textarea class="form-control" name="cancel" cols="10" required=""> </textarea>

					<input type="hidden" name="orderid" value="<?php echo $_GET['id']; ?>">		 
						<div class="space30"></div>
					<input type="submit" class="button btn-lg" value="Cancel Booking">
					</div>
				</div>
