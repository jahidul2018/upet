...
<div class="container">
  ...
  <div  class="error">
   <!--  <p class="p">4</p>
    ...
    <div class="page-ms">
      <p class="page-msg">Congratulations. Your order in placed<span><p></p></span></p>
		<p class="page-msg"> Confirm your Payment.<span><p></p></span></p>
	    <p class="page-msg"> <span>Thank You<p></p></span></p>
      <a href="trainerapplication.php"><button class="go-back" >Cinfirm Payment</button></a>
    </div>
</div>
